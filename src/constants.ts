export const MAINNET_KEYWORDS = ['mainnet', 'tethys', 'one', 'moonriver']

export const ADMISSIBLE_DELAY_MS: number =
  Number(process.env.ADMISSIBLE_DELAY_SECONDS || '0') * 1000

export const DAYS_TO_CONSIDER_FEED_INACTIVE =
  Number(process.env.DAYS_TO_CONSIDER_FEED_INACTIVE) || '7'

export const TIME_TO_CONSIDER_FEED_INACTIVE_MS =
  Number(DAYS_TO_CONSIDER_FEED_INACTIVE) * 24 * 3600 * 1000
